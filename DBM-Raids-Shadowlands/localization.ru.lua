...
L:SetOptionLocalization({
	...
	BladeMarking				= "Установить режим меток в рейде (если Вы лидер рейда, то перезапишет настройки рейда)",
...
L:SetOptionLocalization({
	IconBehavior	= "Установить режим меток в рейде (если Вы лидер рейда, то перезапишет настройки рейда)",
